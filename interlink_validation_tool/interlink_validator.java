...
///////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 public static void main(String[] args){
  ...
  // Read in from external_datasets.txt
  String ext_dataset = "";
    ...
    if(ext_dataset != null && !ext_dataset.isEmpty()){
     if(ext_dataset.charAt(0) != '#'){      
      if(ext_dataset.charAt(0) != ' '){
       ...
       boolean /*param_1_bool = false, param_2_bool = false, param_3_bool = false, param_4_bool = false, param_5_bool = false,*/ param_6_bool = false;
